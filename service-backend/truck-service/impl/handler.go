...
func (h Handler) GetTruckById(ctx context.Context, req *common.IdRequest, res *proto.TruckResponse) error {
...
func (h Handler) GetAllTrucksByFleetCompanyId(ctx context.Context, req *common.IdRequest, res *proto.TrucksResponse) error {
