...
type CustomerService interface {
	...
	DeleteDriverById(ctx context.Context, in *proto1.IdRequest, opts ...client.CallOption) (*DriverResponse, error)
...
func (c *customerService) DeleteDriverById(ctx context.Context, in *proto1.IdRequest, opts ...client.CallOption) (*DriverResponse, error) {
	req := c.c.NewRequest(c.name, "CustomerService.DeleteDriverById", in)
	out := new(DriverResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type CustomerServiceHandler interface {
	...
	DeleteDriverById(context.Context, *proto1.IdRequest, *DriverResponse) error
...
func RegisterCustomerServiceHandler(s server.Server, hdlr CustomerServiceHandler, opts ...server.HandlerOption) error {
	type customerService interface {
		...
		DeleteDriverById(ctx context.Context, in *proto1.IdRequest, out *DriverResponse) error
...
func (h *customerServiceHandler) DeleteDriverById(ctx context.Context, in *proto1.IdRequest, out *DriverResponse) error {
	return h.CustomerServiceHandler.DeleteDriverById(ctx, in, out)
}
